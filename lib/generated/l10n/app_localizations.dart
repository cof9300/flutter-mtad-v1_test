...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Enter user number or phone number'**
  ...
  /// Measurement highlight text
  ///
  /// In en, this message translates to:
  /// **'measure'**
  String get measurementHighlight;

  /// Measurement confirmation question
  ///
  /// In en, this message translates to:
  /// **'Would you like to measure?'**
  String get measurementQuestion;
  ...
  /// Height and weight scale device type
  ///
  /// In en, this message translates to:
  /// **'Height & Weight Scale'**
  String get deviceTypeHC;
  ...
  /// Height and weight measurement result title
  ///
  /// In en, this message translates to:
  /// **'Height & Weight Result'**
  String get heightWeightResultTitle;
  ...
  /// BMI status pre-obese
  ///
  /// In en, this message translates to:
  /// **'Pre-obese'**
  String get bmiStatusPreObese;

  /// BMI status obesity stage 1
  ///
  /// In en, this message translates to:
  /// **'Obesity I'**
  String get bmiStatusObese1;

  /// BMI status obesity stage 2
  ///
  /// In en, this message translates to:
  /// **'Obesity II'**
  String get bmiStatusObese2;

  /// BMI status obesity stage 3
  ///
  /// In en, this message translates to:
  /// **'Obesity III'**
  String get bmiStatusObese3;
  ...
  /// Suffix after highlight for message sent success
  ///
  /// In en, this message translates to:
  /// **' have been sent.'**
  String get sendMessageSuccessSuffix;
  ...
  /// Shown when agreement image URL is missing or failed to load
  ///
  /// In en, this message translates to:
  ...
  /// Device connection not confirmed message
  ///
  /// In en, this message translates to:
  /// **'Device connection not confirmed'**
  String get deviceConnectionNotConfirmed;

  /// Message to check device and port
  ///
  /// In en, this message translates to:
  /// **'Please check the device and port.'**
  String get deviceConnectionCheckMessage;

  /// Alcohol test result screen title
  ///
  /// In en, this message translates to:
  /// **'Alcohol Test Result'**
  String get alcoResultTitle;

  /// Loading message on alcohol result screen
  ///
  /// In en, this message translates to:
  /// **'Receiving result data...'**
  String get alcoResultLoading;

  /// Hidden result message on alcohol result screen
  ///
  /// In en, this message translates to:
  /// **'Result is hidden.'**
  String get alcoResultHidden;

  /// Alcohol result pass message
  ///
  /// In en, this message translates to:
  /// **'Measurement result is normal.'**
  String get alcoResultPass;

  /// Alcohol result pass sub text
  ///
  /// In en, this message translates to:
  /// **'(When blood alcohol level is below 0.030%)'**
  String get alcoResultPassSub;

  /// Alcohol result fail guide message
  ///
  /// In en, this message translates to:
  /// **'Please follow the administrator\'s guidance.'**
  String get alcoResultFailGuide;

  /// Alcohol result fail sub text
  ///
  /// In en, this message translates to:
  /// **'(When blood alcohol level is 0.030% or above)'**
  String get alcoResultFailSub;

  /// Height label in height/weight result
  ///
  /// In en, this message translates to:
  /// **'Height'**
  String get hwHeightLabel;

  /// Weight label in height/weight result
  ///
  /// In en, this message translates to:
  /// **'Weight'**
  String get hwWeightLabel;

  /// BMI label in height/weight result
  ///
  /// In en, this message translates to:
  /// **'BMI'**
  String get hwBmiLabel;
}
