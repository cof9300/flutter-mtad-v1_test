...
import 'package:flutter_template/features/admin/screen/auth_text_edit_screen.dart';
import 'package:flutter_template/features/admin/screen/guest_phone_text_edit_screen.dart';
import 'package:flutter_svg/flutter_svg.dart';

class TextManagementScreen extends ConsumerWidget {
  const TextManagementScreen({super.key});
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const AuthTextEditScreen(),
                          ),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const GuestPhoneTextEditScreen(),
                          ),
                        );
                      },
                      child: Container(
