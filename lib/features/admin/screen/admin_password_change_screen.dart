...
import 'package:flutter_template/features/admin/widget/admin_password_change_widget.dart';
import 'package:flutter_svg/flutter_svg.dart';

class AdminPasswordChangeScreen extends ConsumerWidget {
  const AdminPasswordChangeScreen({super.key});
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: horizontalPadding),
              child: AdminPasswordChangeWidget(),
            ),
          ],
        ),
      ),
